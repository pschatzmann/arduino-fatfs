...
// If you want to use a different SPI port change hspi1 here and elsewhere in
// this file
...
class SDStm32SpiIO : public BaseIO {
 ...
 protected:
  ...
  inline void FCLK_SLOW() {
    MODIFY_REG(hspi1.Instance->CR1, SPI_BAUDRATEPRESCALER_256,
               SPI_BAUDRATEPRESCALER_128);
  } /* Set SCLK = slow, approx 280 KBits/s*/
  inline void FCLK_FAST() {
    MODIFY_REG(hspi1.Instance->CR1, SPI_BAUDRATEPRESCALER_256,
