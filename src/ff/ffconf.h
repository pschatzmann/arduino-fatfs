...
/ 1 = Provide extended functionality
*/

#define FF_NAMESPACE 1
/* The option FF_NAMESPACE defines if we automatically make the namespace fatfs available
/ 0 = The user needs to hadle the namespace himself
/ 1 = execute using fatfs
*/
